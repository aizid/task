...
import com.example.tasks.app.base.navigation.NavigationCommand
...
import com.example.tasks.ext.common.initOnBackPress
...
abstract class BaseFragment<VB : ViewDataBinding, VM : BaseViewModel>
    : Fragment(), MiddleActivity.OnBackPressedListener {
